...
<div id="navigation" class="sticky">
  <nav class="top-bar" role="navigation" data-topbar data-options="scrolltop: false">
    <ul class="title-area">
      <li class="name">
      <h1 class="hide-for-large-up"><a href="http://localhost:4000/" class="icon-tree"> Crameri Coaching</a></h1>
    </li>
    ...
    <section class="top-bar-section">
      ...
      <ul class="left">
              ...
              <li><a  href="http://localhost:4000//ueber-mich/">Über mich</a></li>
              <li class="divider"></li>
              ...
              <li><a  href="http://localhost:4000//coaching/">Coaching</a></li>
              <li class="divider"></li>
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000//themen/">Themen</a>
                  ...
                  <ul class="dropdown">
                      ...
                      <li><a  href="http://localhost:4000//themen/adhs/">ADHS</a></li>
                    

                      

                      <li><a  href="http://localhost:4000//themen/leistung-mentales/">Leistung &amp; Mentales</a></li>
                    

                      

                      <li><a  href="http://localhost:4000//themen/Mann-sein/">Mann sein</a></li>
                    

                      

                      <li><a  href="http://localhost:4000//themen/beziehung-familie/">Beziehung &amp; Familie</a></li>
                    

                      

                      <li><a  href="http://localhost:4000//themen/business-umfeld/">Business-Umfled</a></li>
              ...
              <li><a  href="http://localhost:4000//getting-started/">__quick</a></li>
              <li class="divider"></li>
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000//design/">__Templ</a>
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000//headers/">__Headers</a>
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000//documentation/">__Doc</a>
              ...
              <li class="has-dropdown">
                <a  href="http://localhost:4000//blog/">__Blog</a>
      ...
      <ul class="right">
              ...
              <li class="divider"></li>
              <li><a  href="http://localhost:4000//suche/">__Suche</a></li>
...
<div id="masthead-no-image-header">
	<div class="row">
		<div class="small-12 columns">
			<a id="logo" href="http://localhost:4000//" title="Crameri Coaching – Die Lösung ist immer in dir selbst">
				<img src="http://localhost:4000//assets/img/CrameriCoaching-Logo-horiz.png" alt="Crameri Coaching – Die Lösung ist immer in dir selbst">
			</a>
